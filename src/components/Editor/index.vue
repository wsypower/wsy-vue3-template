 ...
 * @LastEditTime: 2021-12-15 17:45:20
 * @LastEditors: wsy
-->
<template>
  <div class="editor">
...
<script setup>
  ...
  const defaultSetting = ref({
    ...
    toolbar:
      'undo redo | formatselect | bold italic strikethrough forecolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | hr link image media table insertdatetime searchreplace removeformat | preview code fullscreen',
    branding: false,
    menubar: false,
